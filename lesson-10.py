...
# Обучение модели сводится к минимизации функции потерь (сумма квадратов остатков)
...
# Частная производная (по одному из параметров) позволяет определить угловой коэффициент, и изменение параметра выполняется в ту сторону,
# где он максимален/минимален. Для больших угловых коэффициентов делается более широкий "шаг". Ширина шага вычисляется как доля 
# от углового коэффициента и напрямую связана со скоростью обучения. Чем выше скорость, тем быстрее будет работать система. 
# Чем выше скорость, тем быстрее будет работать система за счёт снижения точности. Чем ниже скорость,тем больше времени займёт обучение,
